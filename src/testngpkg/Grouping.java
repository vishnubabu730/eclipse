...
public class Grouping {
	...
	@BeforeMethod(alwaysRun = true)  //only accomadate url loading of webpage
	public void urlloading()
	{
		driver.get("https://automationexercise.com/login");
	}
	
	@Test(groups= {"smoke","sanity"})  //invocationcount (used to repeat the test)  //here priority is blank that means this can taken as priority=0,so this will test first
	...
	@Test(priority=2,groups= {"regression"})  //priority(used to what we need to test first)
	public void signup()
	{
